...
const adminAccounts = {
    ...
    "QRIS": { number: "Scan QRIS Utama", name: "a.n CUFFLI STORE" }
};

// Data Nominal Paket Game
const mlData = [{d:"2 Diamonds", p:"Rp2.000"}, {d:"5 Diamonds", p:"Rp3.000"}, {d:"12 Diamonds", p:"Rp4.000"}, {d:"19 Diamonds", p:"Rp5.500"}, {d:"28 Diamonds", p:"Rp8.000"}, {d:"59 Diamonds", p:"Rp16.000"}, {d:"112 Diamonds", p:"Rp30.000"}, {d:"172 Diamonds", p:"Rp46.000"}, {d:"381 Diamonds", p:"Rp105.000"}, {d:"429 Diamonds", p:"Rp115.000"}, {d:"1136 Diamonds", p:"Rp294.000"}];
...
const pubgData = [{d:"60 UC", p:"Rp15.000"}, {d:"325 UC", p:"Rp72.000"}];
const vloData = [{d:"125 Points", p:"Rp16.000"}, {d:"700 Points", p:"Rp84.000"}];
const codData = [{d:"31 CP", p:"Rp5.000"}, {d:"63 CP", p:"Rp10.000"}];
const kcData = [
...
const hokData = [{d:"8 Tokens", p:"Rp2.000"}, {d:"80 Tokens", p:"Rp16.000"}];
const fcData = [
